...
class PureRiskController(PrimitiveBasedControllerSuper):
    ...
    def initialize_primitives(self, speeds, angles):
        self.MP = MotionPrimitive(speeds, angles,L=.33, p=.2, t_la=2.5, k1=.2, k2=.3, k3=.1, m=.18, c=.12, resolution = (self.resolution, self.resolution), local_grid_size=self.local_grid_size)
